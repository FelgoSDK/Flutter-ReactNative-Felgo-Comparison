...
FlickablePage {
  ...
  rightBarItem: IconButtonBarItem {
    icon: dataModel.isFavorite(model) ? IconType.heart : IconType.hearto
    onClicked: {
  ...
  flickable.contentHeight: contentCol.height + app.contentPadding
  flickable.bottomMargin: app.contentPadding

  Column {
    id: contentCol
    y: app.contentPadding
    anchors { left: parent.left; right: parent.right; margins: app.contentPadding }
